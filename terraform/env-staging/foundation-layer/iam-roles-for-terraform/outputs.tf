output "oidc_provider_arn" {
  description = "ARN of the Terraform Cloud OIDC provider in the staging account"
...
output "account_id" {
  description = "AWS account ID where roles are created (staging account)"
