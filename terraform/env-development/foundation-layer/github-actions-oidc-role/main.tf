...
# =============================================================================
# Per ADR-013: Create OIDC provider and IAM role in the development AWS account
# to allow GitHub Actions to assume a role for EKS provisioning.
#
# This must be deployed to the development AWS account (not management account)
