output "oidc_provider_arn" {
  description = "ARN of the Terraform Cloud OIDC provider in the development account"
...
output "account_id" {
  description = "AWS account ID where roles are created (development account)"
