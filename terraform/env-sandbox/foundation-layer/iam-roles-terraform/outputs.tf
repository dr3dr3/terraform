...
output "experiments_human_role_arn" {
  description = "ARN of the Experiments Human role (Sandbox-specific)"
  value       = module.experiments_human_role.role_arn
}
...
output "experiments_permission_set_arn" {
  description = "ARN of the Experiments Permission Set (Sandbox-specific)"
  value       = module.experiments_permission_set.permission_set_arn
}
